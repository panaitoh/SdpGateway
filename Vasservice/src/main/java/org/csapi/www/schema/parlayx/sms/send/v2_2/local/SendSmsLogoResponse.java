 ...
 */
            ...
            /**
            *  SendSmsLogoResponse bean class
            */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":sendSmsLogoResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "sendSmsLogoResponse",
    ...
    public static class Factory{
        ...
        */
        public static SendSmsLogoResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SendSmsLogoResponse object =
                new SendSmsLogoResponse();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"sendSmsLogoResponse".equals(type)){
                                ...
                                return (SendSmsLogoResponse)org.csapi.www.schema.parlayx.sms.send.v2_2.local.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
