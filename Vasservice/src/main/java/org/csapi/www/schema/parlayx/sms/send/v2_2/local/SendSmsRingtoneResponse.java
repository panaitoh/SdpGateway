 ...
 */
            ...
            /**
            *  SendSmsRingtoneResponse bean class
            */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":sendSmsRingtoneResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
    ...
    public static class Factory{
        ...
        */
        public static SendSmsRingtoneResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SendSmsRingtoneResponse object =
                new SendSmsRingtoneResponse();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"sendSmsRingtoneResponse".equals(type)){
                                ...
                                return (SendSmsRingtoneResponse)org.csapi.www.schema.parlayx.sms.send.v2_2.local.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
